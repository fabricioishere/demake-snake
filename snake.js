function Snake() {
  ...
  // Por meio da condicional, verifica se encontrou um pedaço de comida ou não, checando a distância entre a cobra e a comida, se sim, aumenta seu tamanho (total) em 1
